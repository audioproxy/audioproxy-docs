...
:::note
Synced from [`audioproxy@4e37081`](https://github.com/audioproxy/audioproxy/blob/4e37081/docs/sources.md) — that repo is canonical; edit there, then re-run `bin/sync-proxy-docs`.
:::
